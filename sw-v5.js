const CACHE = 'rd-intranet-v5';
const ASSETS = ['./','./index.html','./styles.css','./enhancements.css','./search-preview.css','./search-preview-v2.css','./app.js','./data.js','./meds.js','./search-preview.js','./search-preview-v2.js','./manifest.webmanifest','./icon.svg','./sw-v5.js'];
